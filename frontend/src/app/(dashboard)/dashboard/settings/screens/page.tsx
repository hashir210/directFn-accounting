...
const AVAILABLE_SCREENS = [
  ...
  { key: 'income', label: 'Income', category: 'Finance', description: 'Organization income tracking by source' },
  { key: 'payments', label: 'Payments', category: 'Finance', description: 'Payment processing and transactions' },
  { key: 'accounting', label: 'Accounting', category: 'Finance', description: 'Chart of accounts, journal entries, and financial reports' },
  { key: 'sales', label: 'Sales Module', category: 'Sales', description: 'POS, sales orders, returns, discounts, and coupons' },
  { key: 'purchases', label: 'Purchases Module', category: 'Purchases', description: 'Purchase orders, goods received, purchase invoices, and supplier returns' },
